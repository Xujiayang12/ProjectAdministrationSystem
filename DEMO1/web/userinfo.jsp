            ...
            <div class="columns">
                <div class="column col-xs-12 col-8 daily_pic">
                    <div class="card">
                        ...
                        <%
                            if (user.getAdmin() == 1) {
                                out.print("<div class=\"card-image\" style=\"background-image:url(./static/admin.png)\"><p>管理员</>");
                            } else {
                                out.print("<div class=\"card-image\" style=\"background-image:url(./static/wo.png)\"><p>普通用户</>");
                            }
                        %>
                    </div>
                    <div class="card-footer bg-gray hide-xs">
                        <div class="card-title"><%= user.getName()%>
                        </div>
                    </div>
                </div>
            </div>
